...
// Define initial state locally in the modal component
...
const ScheduleModal = ({ 
  ...
  const handleKindChange = (e) => {
    ...
    // Reset form based on the new kind while preserving basic fields
    const resetForm = {
      ...getInitialState(), // Use local initial state
      kind: newKind,
      title: form.title || "",
      subject: form.subject || "",
      teacher: form.teacher || "",
      room: form.room || "",
      // Preserve date and day if they exist
      date: form.date || "",
      day: form.day || ""
    }

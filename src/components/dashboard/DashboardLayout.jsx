...
// import { LayoutDashboard, CalendarCheck, CalendarDays, FileText, Megaphone, Users, LogOut, Menu, X } from "lucide-react"
...
//       {/* Sidebar */}
//       <aside className={`fixed inset-y-0 left-0 z-50 w-64 transform flex-col border-r bg-white transition-transform duration-300 ease-in-out md:relative md:translate-x-0 md:flex ${
//         mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'
//       }`}>
//         <div className="flex h-14 items-center justify-between border-b px-4 bg-gradient-to-r from-blue-600/10 to-blue-600/0">
...
//         {/* Top bar on mobile */}
//         <div className="sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-white px-4 md:hidden">
//           <div className="flex items-center gap-2">
//             <button 
...
//           </div>
//           <Link to="/chat" className="rounded-md border px-3 py-1.5 text-sm hover:bg-gray-50 transition-colors">
//             Back to Chat
//           </Link>
//         </div>

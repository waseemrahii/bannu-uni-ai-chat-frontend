    ...
    <div className="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-gray-200 px-3 sm:px-6 py-2.5 sm:py-3">
      <div className="max-w-5xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-sm sm:text-base font-semibold text-gray-900">CS Assistant</h1>
        ...
        <div className="relative flex items-center gap-2" ref={menuRef}>
          {(user?.role === "admin" || user?.role === "cr") && (
            <Link
              to="/dashboard"
              className="hidden sm:inline-flex items-center rounded-md bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700"
          ...
          {/* Main Site Link - Moved outside dropdown */}
          <Link
            to="/"
            className="hidden sm:inline-flex items-center rounded-md bg-gray-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-gray-700 mr-2"
          ...
          <AnimatePresence>
            {open && (
              <motion.div
                ...
                role="menu"
                className="absolute top-full right-0 mt-2 w-56 rounded-xl border border-gray-200 bg-white shadow-lg overflow-hidden z-50"
              >
                <div className="p-2">
                  <Link
                    to="/profile"
                  ...
                  <Link
                    ...
                    role="menuitem"
                  >
                    <Settings className="w-4 h-4 text-gray-500" /> Dashboard
                  </Link>
                                                    )}
...
//           <img src="/images/ustb-logo.png" alt="UST Bannu" className="w-8 h-8 sm:w-9 sm:h-9 object-contain" />
//           <div>
//             <h1 className="text-sm sm:text-base font-semibold text-gray-900">USTB CS Assistant</h1>
//             <div className="flex items-center gap-2">
//               <span className={`w-2 h-2 rounded-full ${isConnected ? "bg-green-500" : "bg-red-500"}`} />
//               <span className="text-xs text-gray-600">{isConnected ? "Connected" : "Disconnected"}</span>
//             </div>
